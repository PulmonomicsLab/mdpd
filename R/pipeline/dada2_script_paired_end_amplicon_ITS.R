#This Rscript allows taxonomic assignments from raw FASTQ files using DADA2 pacakage for paired end Amplicon-ITS bioprojects
#setting the paths
...
#Read the fastq files
  ...
  taxa <- suppressMessages(assignTaxonomy(seqtab.nochim, paste0(input_path_prefix, "sh_general_release_dynamic_04.04.2024.fasta"), multithread=32, minBoot = 100,  tryRC = TRUE))
  taxa.print <- taxa
