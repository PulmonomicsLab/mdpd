        ...
        <script>
            function plot3DInteractiveSVG() {
                var entries = [
                    ...
                    {image: 'resource/text_icons/Pneumonia.png', height:20, width:120, url: 'disease.php?key=Sarcoidosis', target: '_blank', tooltip: 'Group: Pneumonia'},
                    {image: 'resource/text_icons/Pneumonitis.png', height:20, width:120, url: 'disease.php?key=Sarcoidosis', target: '_blank', tooltip: 'Group: Pneumonitis'},
